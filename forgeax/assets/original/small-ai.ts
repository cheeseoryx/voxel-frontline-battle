...
export function installOriginalAI(global, visuals, performance, Math, THREE) {
  ...
  AI.prototype._clearDeathFx = function(){visuals.clear();};
  ...
  AI.prototype._playVoxelDeath = function(unit,hitDir){visuals.death(unit,hitDir);};

  AI.prototype._updateDeathChunks = function(dt){visuals.update(dt);};
