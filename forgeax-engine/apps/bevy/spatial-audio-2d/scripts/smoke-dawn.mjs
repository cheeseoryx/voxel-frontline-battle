...
console.log(`[spatial-audio-2d] backend=${rendererBackend(app.renderer)} frames=${frames} audioResource=${hasAudioEngine} camera=${scene.camera} listener=${scene.listener} emitter=${scene.emitter}`);
