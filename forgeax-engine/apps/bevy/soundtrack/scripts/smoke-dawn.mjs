...
console.log(`[soundtrack] backend=${rendererBackend(app.renderer)} frames=${frames} audioResource=${hasAudioEngine} camera=${scene.camera} peaceful=${scene.peaceful} battle=${scene.battle}`);
const failures = [];
