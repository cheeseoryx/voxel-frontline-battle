...
console.log(`[spatial-audio-3d] backend=${rendererBackend(app.renderer)} frames=${frames} audioResource=${hasAudioEngine} camera=${scene.camera} emitter=${scene.emitter}`);
