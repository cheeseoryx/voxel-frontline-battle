...
console.log(`[smoke] PASS - ${SMOKE_MIN_FRAMES} frames, backend=${rendererBackend(renderer)}, countdownFired=${state.countdownFired}, entityTimerFired=${state.entityTimerFired}`);
process.exit(0);
