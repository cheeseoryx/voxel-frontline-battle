...
it.skipIf(!vertexColorProducerIsScheduled())('runs the ForgeaX Browser WebGPU vertex-color producer', () => {
  ...
  return runVertexColorProducerEntry('forgeax', 'browser-webgpu', forgeaxBundlerAdapter());
