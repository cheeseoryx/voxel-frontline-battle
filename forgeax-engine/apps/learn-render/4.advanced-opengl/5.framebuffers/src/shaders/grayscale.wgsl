// grayscale.wgsl — rec.709 luma grayscale post-process shader.
// Binds screenTexture + screenSampler at @group(1) and returns luma-only output.
...
fn fs_main(in : FullscreenOutput) -> @location(0) vec4<f32> {
  ...
  let luma : f32 = 0.2126 * col.r + 0.7152 * col.g + 0.0722 * col.b;
