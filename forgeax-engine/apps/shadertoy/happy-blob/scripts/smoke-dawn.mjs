...
console.log('[happy-blob] pipeline=Standard');

if (!assets.shaderRegistry.findMaterialArtifact('shadertoy::happy_blob').ok) {
  assets.shaderRegistry.installMaterialArtifact('shadertoy::happy_blob', {
    source: composedWgsl,
    paramSchema: [
