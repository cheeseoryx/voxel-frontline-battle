...
(function (global) {
   ...
   *
   * 美术资产是**显式 opt-in**，不是默认行为。这里的程序化枪是"枪身原点在枪膛、
   * 总长 1.34m"，而 GLB 是真枪尺寸、原点在握把；本套的 createViewModel
   * （modes/small-battle/js/soldier.js）把双手以固定局部坐标 add 到 gun 节点上，
   * 直接换成 GLB 手就浮在枪外了。所以第一人称不在这里吃 GLB，
   * 只有展示界面（modes/small-battle/js/arsenal.js 的预览 canvas）显式要。
   */
  function buildGun(def, opts) {
    // 美术资产优先（assets/weapons/*.glb，注册表在根目录 ../../js/weapon-models.js）。
