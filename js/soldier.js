  ...
  const CLASSES = [
    {
      ...
      role: '进攻与突破',
      blurb:
        '进攻型步兵。主动 X：投掷突破炸药；被动：切枪/换弹更快，执行进攻命令时提升移动效率。',
      activeSkill: {
        name: '突破炸药',
        desc: '按住 X 瞄准抛物线，松手投掷',
      },
      passiveSkill: {
        name: '快速突入',
    ...
    },
    {
      ...
      role: '爆破与工事',
      blurb:
        '反工事与阵地构筑。主动 X：部署自动炮塔；被动：建筑耐久提升并能维修友方部署物。',
      activeSkill: {
        name: '自动炮塔',
        desc: '按住 X 选择位置，松手部署；再次按 X 收回',
      },
      passiveSkill: {
        name: '战地工程',
    ...
    },
    {
      ...
      role: '救援与补给',
      blurb:
        '医疗与弹药保障。主动 X：部署医疗装置；被动：可复活任意友军，拖拽和复活速度更快。',
      activeSkill: {
        name: '医疗装置',
        desc: '按住 X 选择地面位置，松手部署区域医疗装置',
      },
      passiveSkill: {
        name: '全队救援',
    ...
    },
    {
      ...
      role: '标记与渗透',
      blurb:
        '远距观察与敌情标记。主动 X：短时低可见渗透；被动：远距标记与背后攻击强化。',
      activeSkill: {
        name: '低可见渗透',
        desc: '按 X 降低可见度并提升移动速度',
      },
      passiveSkill: {
        name: '观察手',
